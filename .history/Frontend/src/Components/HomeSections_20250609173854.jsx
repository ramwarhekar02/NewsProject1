          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                <span className="text-indigo-600 hover:underline ml-2 cursor-pointer" onClick={(e) => { e.stopPropagation(); handleArticleClick(i); }}>Read More</span>
              </p>
            ...
            <div className="md:flex">
              ...
              <div className="md:w-2/3 p-8">
                ...
                <p className="text-gray-700 mb-6">
                  {article.description.split(' ').slice(0, 15).join(' ')}...
                  <span className="text-indigo-600 font-semibold hover:underline flex items-center gap-2 ml-2 cursor-pointer" onClick={(e) => { e.stopPropagation(); handleArticleClick(article.id); }}>
                    Read More
                  </span>
                </p>
