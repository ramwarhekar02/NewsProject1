...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-300 py-12 mt-12">
      ...
      {/* Powered by PigoPi */}
      <div className="container max-w-xs text mx-auto px-6 mt-8 text-center text-sm text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-blue-500">
