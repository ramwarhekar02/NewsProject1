...
<footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-gray-300 py-8 md:py-12 mt-8 md:mt-12 notranslate">
      <div className="container mx-auto px-4 md:px-10 flex justify-between gap-6 md:gap-8 border-b border-gray-700 pb-6 md:pb-8">
      ...
      <div className="container mx-auto px-6 mt-8 text-center text-sm text-gray-500">
        {t('footer.poweredBy')} <a href="https://pigo-pi.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">max-w-[1350px]</a>
      </div>
    </footer>
  );
};
