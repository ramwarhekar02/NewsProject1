...
export const HeroBanner = ({ heroBanner }) => {
  ...
  useEffect(() => {
    // Update keen-slider on mount and on window resize to fix slide width issues
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center text-white overflow-hidden">
      <div ref={sliderRef} className="keen-slider bg-black bg/opacity-50 h-full w-full">
...
export const VideoNews = ({ videoNewsTitle, videos }) => (
  <motion.section
    ...
    viewport={{ once: true }}
    className="py-16 px-6 container w-full max-w-[1400px] mx-auto"
  >
    {/* Header */}
    <div className="flex justify-between items-center mb-8">
      <motion.h2 
        ...
        viewport={{ once: true }}
        className="text-4xl font-bold uppercase block text-gray-900 tracking-tight gap-4"
      >
       {videoNewsTitle}
       <span className="block w-24 h-1 mt-4 bg-gradient-to-r from-pink-500 to-yellow-400 rounded-full"></span>
      </motion.h2>
