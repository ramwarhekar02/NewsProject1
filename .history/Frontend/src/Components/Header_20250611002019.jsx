      ...
      <nav className="bg-gray-900 text-white">
        <div className="container max-w-[1350px] mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex space-x-6 font-medium tracking-wide text-white ml-8">
            ...
            <a href="/politics" className="hover:text-blue-400 transition-colors duration-300">Politics</a>
            <a href="/sports" className="hover:text-blue-400 transition-colors duration-300">Sports</a>
            <a href="/business" className="hover:text-blue-400 transition-colors duration-300">Business</a>
