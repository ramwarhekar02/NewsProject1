      ...
      <nav className="bg-gray-900 text-white">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <Link to="/" className="flex items-center space-x-2 group" style={{ fontFamily: "'Poppins', sans-serif" }}>
            ...
            <div className="text-3xl md:text-4xl font-extrabold text-gray-100 group-hover:text-red-600 transition-colors duration-300 tracking-wider">
              {logoParts.part2 || t('header.bihar', 'Bihar')} <span className="text-blue-500">{logoParts.part3 || t('header.time', '24/7')}</span>
            </div>
          </Link>
