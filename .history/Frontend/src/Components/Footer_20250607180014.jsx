      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-8">
        ...
        <div>
          <Link to="/" className="flex items-center space-x-2 group mb-4">
            <div className="bg-gradient-to-r from-red-600 to-yellow-500 text-white font-bold px-20 py-2 rounded-md text-xl shadow-md transform group-hover:scale-110 transition-transform duration-300">
              News
            </div>
