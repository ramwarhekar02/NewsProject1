...
<Link
  to="/"
  className="flex flex-col items-start gap-1 group transition-all duration-300 hover:scale-105"
>

  {/* Logo Symbol */}
  <div className="bg-gradient-to-tr from-fuchsia-600 via-rose-500 to-amber-400 text-white font-bold text-sm px-3 py-1 rounded-md shadow-md tracking-wide">
    ✍️ Harshit
  </div>

  {/* Brand Title */}
  <div className="flex flex-col leading-tight ml-1">
    <span className="text-xl sm:text-2xl font-black tracking-tight text-gray-800 group-hover:text-rose-600 transition-colors duration-300">
      के Kalam Se
    </span>
    <span className="text-sm text-gray-500 font-medium tracking-wide group-hover:text-amber-500 transition-colors duration-300">
      Stories, Opinions & Heart
    </span>
  </div>
</Link>
