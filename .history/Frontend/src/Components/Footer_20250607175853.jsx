...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-300 py-12 mt-12">
      <div className="container mx-auto px-20 grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-gray-700 pb-8">
      ...
      {/* Powered by PigoPi */}
      <div className="container max-w-xs text-center mx-auto px-6 mt-8 text-sm text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-yellow-400 to-blue-800">
        Powered by <a href="https://pigopi.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-white">PigoPi</a>
      </div>
    </footer>
  );
};
