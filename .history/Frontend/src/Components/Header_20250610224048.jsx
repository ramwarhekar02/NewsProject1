        ...
        <div className="container max-w-[1350px] mx-auto flex items-center justify-between px-6 py-4">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-xl sm:text-2xl font-extrabold text-gray-900 tracking-tight group-hover:text-pink-600 transition-colors duration-300">
                Harshit ke
              </span>
              <span className="text-sm sm:text-base font-medium text-gray-500 tracking-widest group-hover:text-yellow-500 transition-colors duration-300">
                Kalam Se
              </span>
            </div>
          </Link>
