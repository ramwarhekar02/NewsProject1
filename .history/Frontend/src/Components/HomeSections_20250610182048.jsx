...
export const PhotoGallery = ({ photoGalleryTitle, galleryPhotos }) => (
  ...
  >
    <div className="flex justify-between items-center max-w-[1300px] mx-auto mb-14">
    ...
    <motion.div className="grid grid-cols-2 md:grid-cols-4 w-full  gap-4">
...
export const VideoNews = ({ videoNewsTitle, videos }) => {
  ...
  return (
    <section id="video-news" className="py-16 px-6 container w-full max-w-[1400px] mx-auto">
      <div className="flex justify-between items-center mb-8">
