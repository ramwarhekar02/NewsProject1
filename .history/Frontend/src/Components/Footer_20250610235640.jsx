  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-gray-300 py-8 md:py-12 mt-8 md:mt-12 notranslate">
      <div className="container mx-auto px-4 md:px-10 flex flex-wrap justify-between gap-6 md:gap-8 border-b border-gray-700 pb-6 md:pb-8">
        ...
        <div className="flex flex-col w-full md:w-auto md:flex-grow-0"> {/* Added w-full and md:w-auto for responsiveness */}
        ...
        {/* Navigation links */}
        <div className="w-1/2 md:w-auto"> {/* Added w-1/2 and md:w-auto for responsiveness */}
        ...
        {/* Contact & Subscribe */}
        <div className="w-full md:w-auto md:max-w-xs"> {/* Added w-full and md:w-auto for responsiveness */}
      ...
      <div className="container mx-auto px-6 mt-8 text-center text-sm text-gray-500">
        {t('footer.poweredBy', 'Powered by')} <a href="https://pigo-pi.com/" target="_blank" rel="noopener noreferrer" className="hover:text-white underline">PigoPi</a>
      </div>
    </footer>
  );
};
