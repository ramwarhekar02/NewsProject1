...
const Home = () => {
  ...
  useEffect(() => {
    fetch('/api/customization')
      ...
      .then(data => {
        // Helper function to sort array by date descending
        ...
        setLatestNewsArticles((sortByDateDesc(data.latestNewsArticles) || []).slice(0, 2));
        setFeaturedArticlesTitle(data.featuredArticlesTitle || featuredArticlesTitle);
        setFeaturedArticles((sortByDateDesc(data.featuredArticles) || []).slice(0, 2));
        ...
        setLocalNewsArticles((sortByDateDesc(data.localNewsArticles) || []).slice(0, 3));
      })
      .catch(err => {
  ...
  return (
    <div className="bg-gray-50">
      ...
      <div className="container px-4 md:px-6 py-8 md:py-12 grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12 max-w-[1300px] mx-auto">
