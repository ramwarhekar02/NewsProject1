...
// Sample articles (replace with your real data source)
const newsArticles = [
  {
    id: "1",
    category: "Health",
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="lg:col-span-4 space-y-8">
          ...
          <div className="bg-gray-200 rounded-lg p-4 text-center h-64 flex items-center justify-center">
            <div>
              <div className="text-gray-500 font-semibold">Advertisement</div>
              <div className="text-gray-400 text-sm">300x250</div>
            </div>
          </div>
        </aside>
      </div>
