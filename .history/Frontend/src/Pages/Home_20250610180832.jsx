  ...
  useEffect(() => {
    fetch('/api/customization')
      ...
      .then(data => {
        ...
        setLatestNewsArticles(sortByDateDesc(data.latestNewsArticles) || []);
        setFeaturedArticlesTitle(data.featuredArticlesTitle || featuredArticlesTitle);
        setFeaturedArticles(sortByDateDesc(data.featuredArticles) || []);
        ...
        setLocalNewsArticles(sortByDateDesc(data.localNewsArticles) || []);
      })
      .catch(err => {
