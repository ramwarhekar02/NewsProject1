...
import { FaVideo, FaNewspaper, FaArrowDown, FaChartLine, FaCalendarAlt, FaEnvelope, FaTags, FaMapMarkerAlt, FaLaptopCode, FaUsers, FaArrowRight, FaArrowLeft } from 'react-icons/fa';
      ...
      <div className="container px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-[1400px] mx-auto">
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="space-y-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="flex gap-3 pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                  <div className="bg-indigo-100 text-indigo-800 rounded-lg p-2 text-center min-w-[50px]">
                    <div className="font-bold text-lg">{i + 10}</div>
                    <div className="text-xs uppercase">Jun</div>
                  </div>
                  <div>
                    <h4 className="font-semibold hover:text-indigo-600 transition-colors">
                      {[
            ...
            <a href="#" className="text-indigo-600 hover:underline font-medium flex items-center gap-2 mt-4 text-sm">
