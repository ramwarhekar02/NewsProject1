      ...
      <div className="relative">
        <div ref={sliderRef} className="keen-slider">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white/90 hover:bg-white z-50 p-3 rounded-full shadow-lg z-10 transition-all hover:scale-110"
          >
